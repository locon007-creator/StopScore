...
CREATE TABLE `__new_v2_workdays` (
	...
	CONSTRAINT "v2_workdays_trailer_check" CHECK(("__new_v2_workdays"."equipment_type" = 'tractor' and "__new_v2_workdays"."trailer_type" in ('dry_van', 'reefer', 'flatbed', 'step_deck', 'tanker', 'other')) or ("__new_v2_workdays"."equipment_type" <> 'tractor' and "__new_v2_workdays"."trailer_type" is null and "__new_v2_workdays"."trailer_number" is null)),
